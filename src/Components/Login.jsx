        ...
        <>  
            <div className="flex items-center justify-center h-screen">
                <div className="w-[80vw]  h-[80vh] flex">
                    <div className=" w-full lg:w-1/2 flex items-center bg-blue-900 justify-center border-r border-white rounded-lg shadow-[0_4px_6px_rgba(0,0,0,1)]">
                        <div>
                    ...
                    <div className="w-1/2 flex items-center justify-center bg-white hidden lg:flex rounded-lg shadow-[0_4px_2px_rgba(0,0,0,0.4)]">
